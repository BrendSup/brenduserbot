...
CmdHelp('purge').add_command(
    ...
    'msil', 'Hədəflənən mesajdan başlayaraq öz mesajlarınızı silər.'
).add_command(
    'sil', '<cavab>', 'Göstərdiyiniz mesajı silir.'
).add_command(
    'duzelt və ya düzəlt', '<cavab>' '<yeni mesaj>', 'Cavab verdiyiniz mesajı yeni mesaj ile dəyişdirir.'
).add_command(
    'gizli', '<saniyə> <mesaj>', 'x saniye içində özünü yox edən bir mesaj göndərər.'
).add()
